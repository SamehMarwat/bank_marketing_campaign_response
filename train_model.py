...
DATA_PATH = PROJECT_DIR / "data" / "raw" / "bank_marketing" / "bank-additional" / "bank-additional" / "bank-additional-full.csv"
...
def main():
    ...
    candidates = {
        ...
        "random_forest": RandomForestClassifier(
            n_estimators=250, max_depth=10, min_samples_leaf=10, random_state=42, class_weight="balanced"
        ),
    }
    ...
    scored = df.copy()
    scored["subscription_probability"] = best_pipeline.predict_proba(X)[:, 1]
    ...
    scored.to_csv(OUTPUT_DIR / "bank_marketing_scored_customers.csv", index=False)
